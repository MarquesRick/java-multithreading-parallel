 ...
 */
public class OptimizingForLatencyMain {
    public static final String BASE_DIR = System.getProperty("user.dir");
    public static final String SOURCE_FILE = BASE_DIR + "/src/main/resources/many-flowers.jpg";
    public static final String DESTINATION_FILE =  BASE_DIR + "/src/main/resources/out/many-flowers.jpg";
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (!outputDir.exists()) {
            if (outputDir.mkdirs()) {
                ...
                System.out.println("Failed to create directory: " + outputDir.getAbsolutePath());
            }
        }else{
            ImageIO.write(resultImage, "jpg", outputFile);
        }
